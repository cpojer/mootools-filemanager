...
// Partikule
// Because the header is positionned -30px before the container, we hide it for the moment if the FM isn't standalone.
...
// Partikule. Removed this.info_area
...
// /Partikule
		...
		this.tips = new Tips({
			...
			onShow: function(){
// Partikule
// Fade if Advanced Effects set to true
...
// Partikule
	...
	/**
	 * Catches a double click click on thumb list in the preview thumb list
	 *
	 */
...
// Fading in / out is really boring the user...
...
// /Partikule
	...
	/**
 	 * Show / Hides the Info Divs
	 * With or without fade depending on advanced effects.
	 *
	 */
